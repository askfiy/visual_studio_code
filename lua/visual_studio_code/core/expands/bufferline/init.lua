...
function M.get_highlight(conf, colors)
    return vim.tbl_deep_extend("force", {
        ...
        BufferLineBackground = {
            fg = colors.__vscode_other_table_foreground,
            bg = colors.__vscode_other_table_background,
        },
        ...
        BufferLineTabSeparatorSelected = {
            fg = colors.__vscode_editor_background,
            bg = colors.__vscode_editor_background,
        },
...
function M.get_fileicons_highlights(conf, colors)
    ...
    if ok then
        ...
        for _, name in ipairs(filetype_icons) do
            ...
            fg = fg or colors.__vscode_curr_table_foreground

            hl_groups[string.format("BufferlineDevIcon%s", name)] =
                { fg = colors.__vscode_other_table_foreground, bg = colors.__vscode_other_table_background }
            hl_groups[string.format("BufferlineDevIcon%sInactive", name)] =
                { fg = colors.__vscode_other_table_foreground, bg = colors.__vscode_other_table_background }

            hl_groups[string.format("BufferlineDevIcon%sSelected", name)] =
                { fg = fg, bg = colors.__vscode_curr_table_background }
        end
    end
